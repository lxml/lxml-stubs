...
class _Element(Iterable['_Element'], Sized):
    ...
    def append(self, element: '_Element'): ...
    def cssselect(self, expression: str) -> List[_Element]: ...
    def find(self, path: str, namespace: _OptionalNamespace = ...)  -> '_Element': ...
    def findall(self,
                name: str,
...
class _Attrib:
    ...
    def __deepcopy__(self, memo: Dict) -> _DictAnyStr: ...
    ...
    def __contains__(self, _AnyStr) -> bool: ...
